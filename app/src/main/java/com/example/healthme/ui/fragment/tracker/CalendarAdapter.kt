...
class CalendarAdapter(private val context: Context,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, position: Int): ViewHolder {
        ...
        return ViewHolder(inflater.inflate(R.layout.calendar_cell, parent, false), mListener!!)
    }
    ...
    private fun makeItemDisabled(holder: ViewHolder) {
        ...
        holder.txtDayInWeek!!.setTextColor(ContextCompat.getColor(context, R.color.dark_gray))
    ...
    private fun makeItemSelected(holder: ViewHolder) {
        ...
        holder.linearLayout!!.setBackgroundColor(ContextCompat.getColor(context, R.color.dark_pink))
        holder.linearLayout!!.isEnabled = false
    }
